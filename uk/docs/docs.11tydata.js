...
<meta property="og:image" content="/assets/images/og-images/uk-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="/assets/images/og-images/uk-docs-docs.11tydata.j.png">
...
<script src="/_pagefind/pagefind-ui.js" onload="new PagefindUI({ element: '#search', showImages: false  });"></script>
		...
		<svg class="light-theme-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
					...
					<select class="inline-block language-switcher" tabindex="0">
...
<ul class="nav-list menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Розумний будинок</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/robonomics-smart-home-overview">Огляд</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/install-smart-home">Встановити розумний будинок</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/hass-init">Ініціалізація домашнього асистента</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Додати пристрої</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/zigbee-devices">Пристрої Zigbee</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/virtual-devices">Віртуальні пристрої</a>
    </li></ul>
    </li>
    ...
    <li   data-topic="Smart Home" data-title="Subscription Activate" >
      <a class="menu-link" href="/uk/docs/sub-activate/?topic=smart-home">Активація підписки</a>
    </li>
  
		
    <li   data-topic="Smart Home" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/uk/docs/robonomics-hass-integration/?topic=smart-home">Налаштування інтеграції Robonomics</a>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Розширене налаштування</summary>
        <ul class="menu" role="list">
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Оновлення операційної системи домашнього асистента</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/uk/docs/sub-activate/?topic=upgrade-home assistant os">Активація підписки</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/hass-os-upgrade">Встановлення Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/uk/docs/robonomics-hass-integration/?topic=upgrade-home assistant os">Налаштування інтеграції Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Оновлення домашнього асистента Docker для операційних систем подібних до Unix</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Subscription Activate" >
      <a class="menu-link" href="/uk/docs/sub-activate/?topic=upgrade-home assistant docker for unix-like os">Активація підписки</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Installation" >
      <a class="menu-link" href="/uk/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant docker for unix-like os">Встановлення Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Docker for Unix-like OS" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/uk/docs/robonomics-hass-integration/?topic=upgrade-home assistant docker for unix-like os">Налаштування інтеграції Robonomics</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Оновлення основи домашнього асистента</summary>
        <ul class="menu" role="list">
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Subscription Activate" >
      <a class="menu-link" href="/uk/docs/sub-activate/?topic=upgrade-home assistant core">Активація підписки</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Installation" >
      <a class="menu-link" href="/uk/docs/hass-docker-core-upgrade/?topic=upgrade-home assistant core">Встановлення Robonomics</a>
    </li>
  
		
    <li   data-topic="Upgrade Home Assistant Core" data-title="Robonomics Integration Setup" >
      <a class="menu-link" href="/uk/docs/robonomics-hass-integration/?topic=upgrade-home assistant core">Налаштування інтеграції Robonomics</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Використання</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/add-user">Додати користувача</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/smart-home-telemetry">Отримати телеметрію розумного будинку</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/backup-services">Служби резервного копіювання</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/robonomics-video">Відеосервіс Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/ptz-camera">Керування камерою Rtz в домашньому асистенті</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/pinata-setup">Налаштування Pinata</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/on-chain-gov-experiment">Експеримент управління на ланцюжку</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Схеми</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/use-blueprints">Як використовувати схеми</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/door-notification">Отримуйте сповіщення, коли двері відчиняються</a>
    </li></ul>
    </li>
  </ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Пристрої Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/ir-controller">ІЧ-пульт</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/energy-monitoring">Моніторинг енергії</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/1gang-smart-switch">1-канальний розумний вимикач</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/2gang-smart-switch">2-канальний розумний вимикач</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/sds-sensor-connect">Датчик якості повітря</a>
    </li></ul>
    </li>
    ...
    <li>
      ...
      >
        <summary class="menu-subtitle" >Теорія параланцюжка Robonomics</summary>
        <ul class="menu" role="list">
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/glossary">Глосарій</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/create-account-in-dapp">Створити обліковий запис для параланцюжка Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/run-dev-node">Як запустити вузол розробника Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/adding-funds-to-account-in-dapp">Додавання коштів на ваш обліковий запис на порталі Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/datalog">Основи: Дані журналу</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/launch">Основи: Запуск</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/digital-twins">Основи: Цифрові близнюки</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/liability">Основи: Відповідальність</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/rinterface">Інтерфейс Python та Robonomics IO</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/get-subscription">RWS: Як купити підписку</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/subscription-launch">RWS: Як надіслати запуск з підпискою</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/robonomics-ethereum">Robonomics на Ethereum</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/robonomics-opengov">Robonomics OpenGov</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/how-to-build-collator-node">Як побудувати вузол коллатора з вихідного коду</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/how-to-launch-the-robonomics-collator">Як запустити коллатор Robonomics</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/how-to-update-collator-node-version">Як оновити версію вузла коллатора</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/esp32-datalog-demo">Як надіслати екструзію з ESP</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/edit-wiki">Як редагувати вікі</a>
    </li>
  
		
    <li  >
      <a class="menu-link" href="/uk/docs/contributing">Як внести внесок</a>
    </li></ul>
    </li>
  </ul>
				</div>
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      <div class="robo-wiki-feedback__checkbox">
        <input id="checkbox" type="checkbox" name="checkbox" class="custom-checkbox__field" >
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <span>Не вдалося завершити</span>
      </div>
    </button>
      ...
      <div>
        ...
        <input
          ...
          placeholder="location"
					...
					value="https://wiki.robonomics.network/uk/docs/docs.11tydata.js"
        />
        ...
        <button class="robo-wiki-feedback-form__btn">
          <div class="robo-wiki-feedback-form__btn-wrapper robo-wiki-feedback-form__btn-wrapper--init">
            ...
            <span>Розкажіть нам більше</span>
          </div>
    ...
    <g transform="rotate(0 50 50)">
      ...
      <rect x="46.5" y="22.5" rx="3.5" ry="3.5" width="7" height="7" fill="#fff">
        <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.1764705882352942s" begin="0s" repeatCount="indefinite"></animate>
            ...
            <span>Надсилання вашої інформації...</span>
          </div>
        </button>
      </div>
    </form>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true"   ><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
      <div>Дякую,<br/> ми будемо тримати зв&#39;язок! </div>
    </div>
 ...
 <section class="docContribution">
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+%D0%9E%D1%82%D1%80%D0%B8%D0%BC%D1%83%D0%B9%D1%82%D0%B5+%D1%81%D0%BF%D0%BE%D0%B2%D1%96%D1%89%D0%B5%D0%BD%D0%BD%D1%8F%2C+%D0%BA%D0%BE%D0%BB%D0%B8+%D0%B2%D1%96%D0%B4%D1%87%D0%B8%D0%BD%D1%8F%D1%94%D1%82%D1%8C%D1%81%D1%8F+%D0%B4%D0%B2%D0%B5%D1%80%D1%96"> Створити проблему</a>
        </div>
			</div>
      ...
      <div class="footer__links">
        <ul class="footer__list">
          <li class="footer__item">
            <a class="footer__link" href="/uk/docs/edit-wiki/">
             Як редагувати вікі
            </a>
          </li>
          <li class="footer__item">
            <a class="footer__link" href="/uk/privacy-policy/">
          ...
          <div class="footer-text">
            <span class=""> Переклад виконано штучним інтелектом, тому можуть бути деякі неточності </span>
            <a href="https://github.com/airalab/robonomics-wiki/issues"> Повідомте нас </a>, будь ласка, якщо ви знайдете будь-що
          </div>
