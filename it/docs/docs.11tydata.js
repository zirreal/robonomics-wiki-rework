...
<meta property="og:image" content="./og-images/it-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="./og-images/it-docs-docs.11tydata.j.png">
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <span>Non è stato possibile completare</span>
      </div>
    </button>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      ...
      <div>Grazie,<br/> Rimarremo in contatto! </div>
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+Creare+identit%C3%A0+digitale+gestita+da+Ethereum"> Creare un problema</a>
        </div>
			</div>
