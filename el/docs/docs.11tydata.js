...
<meta property="og:image" content="./og-images/el-docs-docs.11tydata.j.png">
...
<meta name="twitter:image" content="./og-images/el-docs-docs.11tydata.j.png">
...
<section class="robo-wiki-feedback">
    ...
    <button class="robo-wiki-feedback__item" data-text="Couldn&#39;t complete">
      ...
      <div class="robo-wiki-feedback__content">
        ...
        <span>Δεν μπόρεσα να ολοκληρώσω</span>
      </div>
    </button>
    ...
    <div class="robo-wiki-feedback-form__success hide">
      ...
      <div>Ευχαριστώ,<br/> Θα παραμείνουμε σε επαφή! </div>
		...
		<a class="button inline-block primary button__small  " href="https://github.com/airalab/robonomics-wiki/issues/new?assignees=&labels=documentation&template=doc-issue.md&title=issue+for+document+page+-+%CE%94%CE%B5%CE%B4%CE%BF%CE%BC%CE%AD%CE%BD%CE%B1+%CE%BA%CE%B1%CF%84%CE%B1%CE%B3%CF%81%CE%B1%CF%86%CE%AE%CF%82"> Δημιουργήστε ένα θέμα</a>
        </div>
			</div>
